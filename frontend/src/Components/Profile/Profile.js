    ...
    async getUser(targetUser) { 
        ...
        try {
            ...
            if (targetUser === currentUser) {
                response = await axios.get(`${process.env.REACT_APP_BACKEND_ADDR}/api/users/private/${targetUser}`, config);
            } else {
                response = await axios.get(`${process.env.REACT_APP_BACKEND_ADDR}/api/users/${targetUser}`, config);
            }
